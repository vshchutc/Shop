...
class GoodsControllerTest < ActionController::TestCase
  ...
  test "should create good" do
    assert_difference('Good.count') do
      post :create, good: { code: @good.code, description: @good.description, manufacturer: @good.manufacturer, price: @good.price, sizes: @good.sizes, title: @good.title }
    end
  ...
  test "should update good" do
    patch :update, id: @good, good: { code: @good.code, description: @good.description, manufacturer: @good.manufacturer, price: @good.price, sizes: @good.sizes, title: @good.title }
    assert_redirected_to good_path(assigns(:good))
  end
